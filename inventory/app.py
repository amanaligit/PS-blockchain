...
def index():
    ...
    return render_template("inventory.html", message="Please enter Payments detail to continue")
...
def manage_inventory():
    sender = request.form.get("productinfo")
    receiver = request.form.get("warehousenumber")
    amount = request.form.get("volume")
    try:
        amount = int(amount)
    except ValueError:
        return render_template("error.html", message="Please enter a valid amount")
